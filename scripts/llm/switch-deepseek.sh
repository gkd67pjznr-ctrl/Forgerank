#!/bin/bash
# Switch Claude Code backend to DeepSeek V3 (via OpenRouter)
...
// Read OpenRouter key (DeepSeek routes through OpenRouter)
...
console.log('Switched to DeepSeek V3 backend (via OpenRouter).');
console.log('Added 6 env vars to .claude/settings.local.json');
console.log('  Haiku  -> deepseek/deepseek-chat');
console.log('  Sonnet -> deepseek/deepseek-chat');
console.log('  Opus   -> deepseek/deepseek-chat');
console.log('');
